        ...
        state.map(
            ...
            tryAgainSendingVerification: (_)=>{
              Flushbar(
                ...
                backgroundGradient:
                 LinearGradient(colors: [Colors.red[200], Colors.red[900]]),
            ...
            waitForTime:(value)=>{
              Flushbar(
                ...
                backgroundGradient:
                const LinearGradient(colors: [Color.fromARGB(255,248,87,166,), Color.fromARGB(255,255,88,88)]),
                backgroundColor: Colors.red,
                boxShadows: const[
                  BoxShadow(
            ...
            creatingDocument: (value)=>{
                creatingDocument = value.creating
            },
            ...
            initialState: (_)=>{
              context.bloc<ValidationBloc>().add(const ValidationEvent.sendVerificationEmail())
            ...
            children: [
              ...
              Padding(
                ...
                child: Center(
                    child: Column(
                  children: <Widget>[
                    if (!creatingDocument&&!sendingEmailVerification) Container(
                      height: 50,
                      child: RaisedButton(
